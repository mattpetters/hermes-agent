...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("tmux", "Spawn Hermes agents in tmux panes, windows, or sessions", "Tools & Skills",
               cli_only=True, args_hint="<pane|window|session|status|kill> [prompt]",
               subcommands=("pane", "window", "session", "status", "kill")),
