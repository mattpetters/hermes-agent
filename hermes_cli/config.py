...
# =============================================================================
# Safe nested-dict accessor (defined early so it's available even if later
# module-level code raises during import — avoids the "cannot import name
# 'cfg_get'" ImportError that occurs when a partial module load leaves
# cfg_get undefined).
# =============================================================================
...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        # This personal fork defaults to the read-only Obsidian provider; it
        # auto-discovers ~/vaults/vault-one unless OBSIDIAN_VAULT_PATH is set.
        "provider": "obsidian",
    },
